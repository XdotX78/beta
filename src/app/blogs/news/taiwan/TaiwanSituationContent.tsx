...
const categories = [
    ...
    { id: "military", name: "Military Activities" },
    { id: "diplomacy", name: "Diplomatic Relations" },
    { id: "security", name: "Regional Security" },
    { id: "economy", name: "Economy & Trade" },
    { id: "politics", name: "Politics" },
    { id: "society", name: "Society & Culture" },
];

interface TaiwanSituationContentProps {
    posts: Post[];
    featuredPosts: Post[];
}

export default function TaiwanSituationContent({ posts, featuredPosts }: TaiwanSituationContentProps) {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900">
            ...
            <div className="relative bg-cover bg-center h-[50vh]"
                style={{ backgroundImage: "url('/images/blog/taiwan-hero.jpg')" }}>
                ...
                <div className="relative container mx-auto px-4 h-full flex flex-col justify-center z-10">
                    ...
                    >
                        Comprehensive coverage of cross-strait relations, regional security, and diplomatic developments
                    </motion.p>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-white">
                        ...
                        <div className="flex items-center bg-black/30 px-3 py-1 rounded-full">
                            ...
                            <Link href="/maps/news?region=taiwan" className="hover:underline">
                                View on News Map
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-2/3">
                        ...
                        <div className="mb-10 flex flex-col sm:flex-row gap-4">
                            <div className="relative flex-grow">
                                <input
                                    type="text"
                                    placeholder="Search Taiwan updates..."
                                    value={searchQuery}
                            ...
                            <div className="mb-12">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {featuredPosts.map(post => (
                                        <Link href={`/blogs/news/taiwan/${post.slug}`} key={post.slug} className="group">
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <div className="bg-blue-50 rounded-xl p-6 mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Our Taiwan Situation coverage provides comprehensive reporting on cross-strait relations,
                                regional security developments, and international diplomatic initiatives in the Taiwan Strait region.
                            </p>
                            <p className="text-gray-700 mb-4">
                                Our team of correspondents across Asia delivers timely updates and in-depth analysis of this
                                complex geopolitical situation.
                            </p>
                            <div className="flex gap-2 flex-wrap">
                                <Link
                                    href="/maps/news?region=taiwan"
                                ...
                                <Link
                                    href="/blogs/news?tag=taiwan-analysis"
                                    className="inline-flex items-center text-sm bg-white px-3 py-1 rounded-full text-blue-600 hover:bg-blue-600 hover:text-white transition-colors"
                                >
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                            ...
                            <div className="space-y-4">
                                <div className="border-b border-gray-200 pb-3">
                                    <p className="text-sm text-gray-500">Military Activities</p>
                                    <p className="text-lg font-semibold">Regular exercises in the region</p>
                                </div>
                                <div className="border-b border-gray-200 pb-3">
                                    <p className="text-sm text-gray-500">Diplomatic Relations</p>
                                    <p className="text-lg font-semibold">13 diplomatic allies</p>
                                </div>
                                <div className="border-b border-gray-200 pb-3">
                                    <p className="text-sm text-gray-500">Economic Integration</p>
                                    <p className="text-lg font-semibold">$166B annual trade with mainland</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">International Support</p>
                                    <p className="text-lg font-semibold">Growing strategic partnerships</p>
                                </div>
                            </div>
                            <div className="mt-4 text-xs text-gray-500">
                                Source: Various international organizations (2024)
                            </div>
                        </div>
                                    ...
                                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                                        <div className="relative h-32">
                                            ...
                                            <div className="absolute bottom-0 w-full p-4">
                                                ...
                                                <p className="text-sm text-gray-300">Latest developments in Ukraine</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
