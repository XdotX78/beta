...
import { FaSearch, FaFilter, FaTimes, FaCalendarAlt, FaMap, FaHistory, FaTag } from 'react-icons/fa';
...
const categories = [
    ...
    { id: "politics", name: "Political Developments" },
    { id: "society", name: "Society & Impact" },
];

interface SudanContentProps {
    posts: Post[];
    featuredPosts: Post[];
}

export default function SudanContent({ posts, featuredPosts }: SudanContentProps) {
    const [searchQuery, setSearchQuery] = useState('');
    const [selectedCategory, setSelectedCategory] = useState('all');
    const [selectedTags, setSelectedTags] = useState<string[]>([]);
    const [showFilters, setShowFilters] = useState(false);

    const allTags = Array.from(new Set(posts.flatMap(post => (post.tags as string[]) || [])));
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900">
            ...
            <div className="relative bg-cover bg-center h-[50vh]"
                style={{ backgroundImage: "url('/images/blog/sudan-crisis.jpg')" }}>
                <div className="absolute inset-0 bg-gradient-to-b from-blue-900/80 via-blue-900/60 to-red-500/30"></div>
                <div className="relative container mx-auto px-4 h-full flex flex-col justify-center z-10">
                    ...
                    >
                        Comprehensive coverage of the ongoing situation in Sudan, including analysis, updates, and humanitarian impact.
                    </motion.p>
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-white">
                        ...
                        <div className="flex items-center bg-black/30 px-3 py-1 rounded-full">
                            ...
                            <Link href="/maps/news?region=sudan" className="hover:underline">
                                View on News Map
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-2/3">
                        ...
                        <div className="mb-10 flex flex-col sm:flex-row gap-4">
                            <div className="relative flex-grow">
                                <input
                                    type="text"
                                    placeholder="Search Sudan updates..."
                                    value={searchQuery}
                        ...
                        {showFilters && (
                            <div className="mt-4 p-4 border rounded-lg mb-6">
                        ...
                        {/* Featured Articles */}
                        {searchQuery === "" && selectedCategory === "all" && selectedTags.length === 0 && featuredPosts.length > 0 && (
                            <div className="mb-12">
                                <h2 className="text-2xl font-bold mb-6 text-gray-900">Latest Developments</h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {featuredPosts.map(post => (
                                        <Link href={`/blogs/news/sudan/${post.slug}`} key={post.slug} className="group">
                    ...
                    <div className="lg:w-1/3">
                        ...
                        <div className="bg-blue-50 rounded-xl p-6 mb-8">
                            ...
                            <p className="text-gray-700 mb-4">
                                Our Sudan Crisis coverage provides comprehensive reporting on the ongoing conflict,
                                humanitarian situation, and international response to the crisis in Sudan.
                            </p>
                            <p className="text-gray-700 mb-4">
                                Our team of correspondents across Africa delivers timely updates and in-depth analysis of this
                                complex humanitarian emergency.
                            </p>
                            <div className="flex gap-2 flex-wrap">
                                <Link
                                    href="/maps/news?region=sudan"
                                ...
                                <Link
                                    href="/blogs/news?tag=sudan-analysis"
                                    className="inline-flex items-center text-sm bg-white px-3 py-1 rounded-full text-blue-600 hover:bg-blue-600 hover:text-white transition-colors"
                                >
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                            ...
                            <div className="space-y-4">
                                <div className="border-b border-gray-200 pb-3">
                                    ...
                                    <p className="text-lg font-semibold">Over 24.7 million people</p>
                                </div>
                                <div className="border-b border-gray-200 pb-3">
                                    <p className="text-sm text-gray-500">Displaced People</p>
                                    <p className="text-lg font-semibold">6.3 million internally displaced</p>
                                </div>
                                <div className="border-b border-gray-200 pb-3">
                                    <p className="text-sm text-gray-500">Humanitarian Need</p>
                                    <p className="text-lg font-semibold">$2.7B required for response</p>
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">International Response</p>
                                    <p className="text-lg font-semibold">Multiple peace initiatives</p>
                                </div>
                            </div>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="space-y-4">
                                <Link href="/blogs/news/yemen" className="block group">
                                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                                        <div className="relative h-32">
                                            <Image
                                                src="/images/blog/yemen-crisis.jpg"
                                                alt="Yemen Crisis"
                                                fill
                                            ...
                                            <div className="absolute bottom-0 w-full p-4">
                                                ...
                                                <p className="text-sm text-gray-300">Latest developments in Yemen</p>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
