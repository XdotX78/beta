...
// Import the MDX files directly
const posts = [
  {
    slug: "russian-offensive-eastern-front",
    title: "Russian Forces Launch Major Offensive on Eastern Front",
    excerpt: "Russian military launches significant offensive operations in eastern Ukraine, targeting key strategic positions along the front line.",
  ...
  {
    slug: "western-allies-boost-military-aid",
    title: "Western Allies Announce $50 Billion Military Aid Package for Ukraine",
    excerpt: "NATO countries commit to unprecedented military aid package, including advanced air defense systems and long-range capabilities.",
    imageUrl: "https://plus.unsplash.com/premium_photo-1705367094846-3263f7d3a776",
    category: "diplomacy",
...
export default function UkraineCrisisPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="relative bg-cover bg-center h-[50vh]"
        style={{ backgroundImage: "url('https://plus.unsplash.com/premium_photo-1705367094846-3263f7d3a776')" }}>
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {featuredPosts.map(post => (
                    <Link href={`/blogs/news/ukraine/${post.slug}`} key={post.slug} className="group">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <Link href="/blogs/news/palestine" className="block group">
                  <div className="relative h-32">
                    <Image
                      src="https://images.unsplash.com/photo-1649089457308-7d0446772f7f?auto=format&fit=crop&w=800&h=400&q=80"
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-xl">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 h-64 md:h-80 relative">
                <Image
                  src="https://images.unsplash.com/photo-1649089457308-7d0446772f7f?auto=format&fit=crop&w=800&h=600&q=80"
